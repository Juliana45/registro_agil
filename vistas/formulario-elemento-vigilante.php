...
<!-- formulario registro elemento -->
    <div id="form-registro-elemento">
        ...
        <hr class="linea-ele">
        <div id="registro">
            <form action="../phpCode/codigo_elemento_vigilante.php" method="POST" enctype="multipart/form-data">
                ...
                onkeypress="return numeros(event)" onpaste="return false" required><br>
