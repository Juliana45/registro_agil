    ...
    <div class="codigo-barras">
        ...
        <?php
            ...
            */
             ...
             *                              donde el numero de documento del supervisor debe 
             *                              ser igual al numero de documento registrado en la 
             *                              base de datos y el estado del elemento debe ser 
             *                              diferente a 0.
             */
        ...
        endforeach
    ?> 
        <!-- manda por la url la variable persona que contiene el numero del documento del supervisor -->
