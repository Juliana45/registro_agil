...
<!--inicio_registro_elemento-->
    <div id="form-registro-elemento">
        ...
        <hr class="linea-ele">
        <div id="registro">
            <form action="../phpCode/insertar_sin_serial.php" method="POST" enctype="multipart/form-data">
                <input class="input" type="text" name="nombre" placeholder="Nombre" onkeypress="return Letras(event)" onpaste="return false">
                <input class="input" type="text" name="descripcion" placeholder ="Descripción" onkeypress="return Letrasynumeros(event)" onpaste="return false">
