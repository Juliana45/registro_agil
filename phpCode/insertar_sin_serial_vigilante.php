 ...
 * vigilante, en el archivo elemento_sin_serial_vigilante.php 
 */
if(isset($_POST['registro_ele'])) {
     ...
     * 
     * si todos los campos del formulario registro elemento sin serial del vigilante,
     * en el archivo elemento_sin_serial_vigilante.php estan llenos 
     */
    if(strlen($_POST['nombre']) >=1 && strlen($_POST['descripcion'])>=1){
         ...
         *  elemento sin serial del vigilante, en el archivo elemento_sin_serial_vigilante.php 
         * @var String $nombre
         ...
         *                                 vigilante, en el archivo elemento_sin_serial_vigilante.php a la base de datos
        ...
        $resultado = mysqli_query($conexion,$insertar);
            ...
            if ($resultado) {
                ...
                /**
                 * se llama la alerta con la funcion perfilVigilanteElemetoSinSerial
                 */
