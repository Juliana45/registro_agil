...
/**
 * si le dio clic en el boton 'registro_ele' del formulario registro elemento en elemento_sin_serial.php 
 */
if(isset($_POST['registro_ele'])) {
     ...
     * 
     * si todos los campos del formulario registro elemento en elemento_sin_serial.php estan llenos 
     */
    if(strlen($_POST['nombre']) >=1 && strlen($_POST['descripcion'])>=1){
         ...
         * registro elemento en elemento_sin_serial.php 
         * @var String $nombre
         ...
         *                                 en elemento_sin_serial.php a la base de datos
