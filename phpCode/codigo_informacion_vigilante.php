...
/**
 * si le dio clic en el boton 'guardar' del formulario actualizar informacion del vigilante, en el archivo perfil_vigilante.php 
 */
if(isset($_POST['guardar'])){
     ...
     * 
     * si todos los campos del formulario actualizar informacion del vigilante, en el archivo perfil_vigilante.php estan llenos 
     */
    ...
    strlen($_POST['apellido1']) >=1 && strlen($_POST['apellido2']) >=1 && strlen($_POST['tipo']) >=1 ) {
         ...
         * actualizar informacion del vigilante, en el archivo perfil_vigilante.php
