...
include '../conexi/conexion.php';
    ...
    * $_GET             Obtiene la variable desactivar que se envia por la url desde el archivo mis_elementos.php
    * desactivar        almacena el numero serial del elemento
    *
    * si se resive el numero serial del elemento enviado por la url desde el archivo mis_elementos.php          
    */
   if (isset($_GET["desactivar"])) {

      /**
       * @var String $id      Almacena el dato enviado por la url desde el archivo mis_elemento.php
       */
      $id = $_GET['desactivar'];
