...
/**
 * si le dio clic en el boton 'registro_ele' del formulario registro elemento en formulario_elemento_super.php 
 */
if(isset($_POST['registro_ele'])) {
     ...
     * 
     * si todos los campos del formulario registro elemento en formulario_elemento_super.php estan llenos 
     */
    if(strlen($_POST['numero_serial']) >=1 && strlen($_POST['nombre']) >=1 && strlen($_POST['descripcion'])>=1){
         ...
         * registro elemento en formulario_elemento_super.php
         ...
         *                              formulario_elemento_super.php a la base de datos
