...
/**
 * Insertar elemento del supervisor
 * 
...
/**
 * si le dio clic en el boton 'registro_ele' del formulario registro elemento del supervisor, en el archivo formulario_elemento_super.php 
 */
if(isset($_POST['registro_ele'])) {
     ...
     * 
     * si todos los campos del formulario registro elemento del supervisor, en el archivo formulario_elemento_super.php estan llenos 
     */
    if(strlen($_POST['numero_serial']) >=1 && strlen($_POST['nombre']) >=1 && strlen($_POST['descripcion'])>=1){
         ...
         * elemento del supervisor, en el archivo  formulario_elemento_super.php
         ...
         * @var String $destido         almacena la ruta donde se guarda el archivo
         ...
         * 
         * @var String $insertar        se estan insertando los datos ingresados en el formulario registro elemento del supervisor, en 
         *                              el archivo formulario_elemento_super.php a la base de datos
