        ...
        ?>
            <div class="contenedor-carta">
                ...
                <div class="contenedor-txt"> 
                    ...
                    <!-- se esta mandado por la url la variable ingreso que contiene el numero serial del elemento -->
                    ...
                    <!-- se esta mandado por la url la variable salida que contiene el numero serial del elemento -->
