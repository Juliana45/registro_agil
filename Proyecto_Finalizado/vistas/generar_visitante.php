    ...
    <!-- inicio fotos y botones de menu -->
        <div class="contenedor-foto">
            ...
            ?>
                ...
                <!-- se esta mandado por la url la variable persona que contiene el numero de documento del vigilante -->
    ...
    <div id="barra">
        ...
        <!-- inicio codigo barras -->
            <?php
                 ...
                 * @var string $arraycodigo    Almacena un vector donde se guarda la foto y el numero serial generado.   
                 */
                $result = mysqli_query($conexion,$sql);
                
                $arraycodigo = array();?>

                <table id="tabla_sticker_visitante">

                    <tr class="sticker_visitante">
                    ...
                    ?>
                            ...
                            <tr class="sticker_visitante">
                                ...
                                <td>
                                    ...
                                    /**
                                     * @var string $ver     Esta mostrando la posision 0 que contiene la imagen 
                                     *                      con el codigo de barras.               
                                     */ 
            ...
            <!-- boton finalizar proceso descargar stcker -->
            <a href="../vistas/verificacion.php" ><button id="terminado_visitante">Terminado</button><br></a>
