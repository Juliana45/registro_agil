 ...
 */
    ...
    if(documento === "" || nombre1 === "" || apellido1 === "" || foto === "" || clave === "" || tipo === "" || correo === ""){
        /**
         * se llama la funcion Swal.fire de la libreria SweetAlert2(agregada en el archivo index.php) para mostrar la alerta
         */
        Swal.fire({
            title: 'Ups!',
...
function validar_elemento(){
   ...
   /**
	...
	if(nombre === "" || descripcion === "" || serial === "" || foto === ""){
        /**
         * se llama la funcion Swal.fire de la libreria SweetAlert2(agregada en el archivo editar_elemento_supervisor.php,
         * editar_elemento_usuario.php, editar_elemento_vigilante.php, formulario_elemento.php, formulario_elemento_super.php,
         * formulario_elemento_vigilante.php) para mostrar la alerta
         */
        Swal.fire({
            title: 'Ups!',
            text: 'Todos los campos son obligatorios', 
    ...
    /**
     * si la variable serial es mayor o igual a 20 caracteres o menor a 6, se mostrara una alerta.
     */
...
/**
 * valida los formularios  de los archivos elemento_sin_serial.php, elemento_sin_serial_vigilante.php y elemento_sin_serial_super.php
 */
function validar_sinserial(){
   ...
   /**
    ...
    if(nombre === "" || descripcion === "" || serial === "" || foto === ""){
        /**
         * se llama la funcion Swal.fire de la libreria SweetAlert2(agregada en el archivo elemento_sin_serial_super.php,
         * elemento_sin_serial.php, elemento_sin_serial_vigilante.php) para mostrar la alerta
         */
        Swal.fire({
            title: 'Ups!',
            text: 'Todos los campos son obligatorios', 
...
/**
 * valida los formularios  de actualizar la información personal en los 3 perfiles (usuario,supervisor,vigilante).
 */
...
/**
 * valida los formularios  de actualizar la clave en los 3 perfiles (usuario,supervisor,vigilante).
 */ 
...
/**
 * verifica que el formulario registro del vigilante en el archivo listar_vigilantes.php, y registro del visitante en
 * el archivo verificacion.php
 */
    ...
    if(docu === "" || nom1 === "" || ape1 === "" || clave === "" || tipo === "" || correo === ""){
        /**
         * se llama la funcion Swal.fire de la libreria SweetAlert2(agregada en el archivo lista_vigilantes.php,
         * verificacion.php) para mostrar la alerta
         */
        Swal.fire({
            title: 'Ups!',
            text: 'Todos los campos son obligatorios', 
...
function validar_buscador(){
    ...
    if(documento === ""){
        /**
         * se llama la funcion Swal.fire de la libreria SweetAlert2(agregada en el archivo verificacion.php) para mostrar la alerta
         */
        Swal.fire({
            title: 'Ups!',
...
/**
 * valida los campos del formulario registrar visitante, en el archivo verificacion.php
 */
function visitante_sinserial(){
    ...
    /**
     * si la variable docum es mayor a 10 o menor a 8 caracteres se mostrara una alerta
     */
    ...
    /**
     * si la variable nomb es menor a 4 caracteres, se mostrara una alerta.
     */
    ...
    /**
     * si la variable nomb es mayor o igual a 50 caracteres, se mostrara una alerta.
     */
    ...
    /**
     * si la variable descrio es menor a 4 caracteres, se mostrara una alerta.
     */
    ...
    /**
     * si la variable descri es mayor o igual a 110 caracteres, se mostrara una alerta.
     */
